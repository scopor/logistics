  ...
  <div class="min-h-screen bg-background text-foreground">
    ...
    <section class="relative py-40 bg-cover bg-center"
      ...
      <div class="container mx-auto px-4 text-center relative z-10 h-96">
        <h2 class="text-5xl font-bold lg:mb-8 text-white">全国物流解决方案</h2>
        <p class="text-xl lg:mb-16 text-white">快速、可靠、高效的货物运输服务</p>
    ...
    <footer class="bg-primary text-primary-foreground py-12">
      <div class="container mx-auto px-4">
        ...
        <div class="mt-8 pt-8 border-t border-primary-foreground/20 text-center">
          <p>&copy; 2023 粤宝. 保留所有权利。<a href="https://beian.miit.gov.cn/">备案号：粤ICP&nbsp;备2022072584号</a>
          </p>
        </div>
      </div>
    </footer>
