  ...
  <div class="min-h-screen bg-background text-foreground">
    ...
    <header
      ...
      <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold px-4 py-2 neon-purple"><a href="/">粤宝物流供应链</a></h1>
        <nav>
    ...
    <section class="relative py-40 bg-cover bg-center"
      ...
      <div class="container mx-auto px-4 text-center relative z-10 h-96">
        ...
        <p class="text-xl font-thin mb-4 text-white text-start indent-10">
          粤宝供应链拥有在供应链及物流行业内经验丰富的资深专业团队，能为您在高档鞋服、直销行业、保健食品、日化用品等行业领域提供供应链战略及计划，物流服务等方面提供专业的咨询服务。</p>
        <p class="text-xl font-thin lg:mb-8 text-white text-start indent-10">
    ...
    <footer class="bg-primary text-primary-foreground py-12">
      <div class="container mx-auto px-4">
        ...
        <div class="mt-8 pt-8 border-t border-primary-foreground/20 text-center flex flex-col md:flex-row md:justify-center">
          <p>&copy; 2024 粤宝. 保留所有权利。</p>
          <a href="https://beian.miit.gov.cn/">备案号：粤ICP&nbsp;备2022072584号</a>
        </div>
      </div>
    </footer>
  </div>
